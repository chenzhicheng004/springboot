 ...
 */
@Configuration
public class DadaSourceConfig implements BeanDefinitionRegistryPostProcessor, EnvironmentAware {
...
//        System.out.println("DadaSourceConfig.postProcessBeanDefinitionRegistry()");
//        try {
...
//            e.printStackTrace();
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        System.out.println("DadaSourceConfig.postProcessBeanFactory()");
        //设置为主数据源;
...
//        System.out.println("DadaSourceConfig.setEnvironment()");
//
//        /*
